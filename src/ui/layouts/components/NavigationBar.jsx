    ...
    return (
        <nav>
            ...
            <div className="navNavDiv">
                <p className="nav-hide"><Link to="/">Home</Link></p>
                <p className="nav-hide"><Link to="/shop">Shop</Link></p>
                <p className="nav-hide"><Link to="">About</Link></p>
                <p className="nav-hide"><Link to="">Contact</Link></p>
                <p className="nav-hide"><Link to="">FAQ</Link></p>
